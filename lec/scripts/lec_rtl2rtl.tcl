...
read_design [list /pkgs/synopsys/2020/32_28nm/SAED32_EDK/lib/stdcell_rvt/verilog/saed32nm.v ../../syn/outputs/$env(TOP2).dc.vg ] -verilog  -revised -sensitive -continuousassignment Bidirectional -nokeep_unreach   -nosupply -root $env(TOP2)
set_system mode lec
